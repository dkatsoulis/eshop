...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 20, 2017 at 01:48 PM
...
('root', '[{"db":"eshop","table":"users"},{"db":"eshop","table":"orders"},{"db":"eshop","table":"orderproducts"},{"db":"eshop","table":"products"},{"db":"eshop","table":"orderProducts"},{"db":"eshop","table":"Orders"},{"db":"eshop","table":"Users"}]');
...
('eshop', 'orderproducts', 'orderId', 'eshop', 'orders', 'id'),
('eshop', 'orderproducts', 'productId', 'eshop', 'products', 'id'),
('eshop', 'orders', 'userId', 'eshop', 'users', 'id');
...
('root', '2017-01-04 21:05:11', '{"collation_connection":"utf8mb4_unicode_ci"}');
